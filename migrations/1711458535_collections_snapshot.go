	...
	m.Register(func(app core.App) error {
		jsonData := `[
			...
			},
			{
				...
				"id": "2z10pbo7szq8uls",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_ARw7rrKffB` + "`" + ` ON ` + "`" + `playing_levels` + "`" + ` (` + "`" + `name` + "`" + `)"
				],
			...
			},
			{
				...
				"id": "xq7lqom9imfoxlx",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_yH6JLMIrhv` + "`" + ` ON ` + "`" + `competitions` + "`" + ` (\n  ` + "`" + `teamSize` + "`" + `,\n  ` + "`" + `genderCategory` + "`" + `,\n  ` + "`" + `ageGroup` + "`" + `,\n  ` + "`" + `playingLevel` + "`" + `\n)"
				],
				"listRule": "@request.auth.id != \"\"",
				"name": "competitions",
				"system": false,
			...
			},
			{
				...
				"id": "25ej3p66dvflsof",
				"indexes": [
					"CREATE UNIQUE INDEX ` + "`" + `idx_aJQyBbxov3` + "`" + ` ON ` + "`" + `age_groups` + "`" + ` (\n  ` + "`" + `type` + "`" + `,\n  ` + "`" + `age` + "`" + `\n)"
				],
				"listRule": "@request.auth.id != \"\"",
				"name": "age_groups",
				"system": false,
			...
			},
			{
				...
				"fields": [
					...
					{
						"cascadeDelete": false,
						"collectionId": "pbc_2122568942",
						"hidden": false,
						"id": "relation4115728561",
						"maxSelect": 999,
						"minSelect": 0,
						"name": "startingFeeMassDiscounts",
						"presentable": false,
						"required": false,
						"system": false,
						"type": "relation"
